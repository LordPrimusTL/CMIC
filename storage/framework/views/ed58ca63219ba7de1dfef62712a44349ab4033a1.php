                            ...
                            <form class="form-" method="POST" action="<?php echo e(route('admin_invs_search')); ?>">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group-sm ">
                                        ...
                                        <a href="<?php echo e(route('admin_invs')); ?>" style="margin-top: 5px;" class="btn btn-outline-primary btn-sm">All Investors</a>
                    ...
                    <?php if(count($reg) > 0): ?>
                        <div class=" table table-responsive">
                            <table id="table" class="table table-bordered">
                                ...
                                <tbody>
                                <?php $i =1;?>
                                <?php $__currentLoopData = $reg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $in): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $g = $in->s_id;?>
                                    <tr class="<?php if($g == 1): ?> alert-success <?php elseif($g == 2 || $g == 4): ?> alert-warning <?php elseif($g == 3): ?> alert-danger <?php endif; ?>">
                                        ...
                                        <td><?php echo e(\App\inv_aff::find($in->inv_id)->name); ?></td>
                                        ...
                                        <td>
                                            <?php if($g == 1): ?>
                                                N/A
                                            <?php elseif($g ==2): ?>
                                                <a href="<?php echo e(route('admin_invs_auth',['id' => $in->id * 8009 * 8009])); ?>" class="btn btn-outline-success btn-sm"><i class="fa fa-check"></i> Authorize</a>
                                                <a href="<?php echo e(route('reg_delete',['id' => $in->id * 8009 * 8009])); ?>" class="btn btn-outline-danger btn-sm"><i class="fa fa-close"></i> Decline</a>
                                            <?php elseif($g == 3): ?>
                                                No Action
                                            <?php elseif($g == 4): ?>
                                                <a href="<?php echo e(route('reg_delete',['id' => $in->id * 8009 * 8009])); ?>" class="btn btn-outline-danger btn-sm"><i class="fa fa-close"></i> Interrupt</a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
