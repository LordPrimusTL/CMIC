        ...
        <div class="container">
            <div class="w3_footer_grids container-fluid">
                ...
                <div class="col-md-4 w3_footer_grid">
                    <h3>Information</h3>
                    <ul class="info">
                        <li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="<?php echo e(route('about')); ?>">About Us</a></li>
                        <li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="<?php echo e(route('contact')); ?>">Contact Us</a></li>
                ...
                <div class="col-md-4 w3_footer_grid">
                    <h3>JOIN TODAY</h3>
                    <ul class="info">
                        <li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="<?php echo e(route('login')); ?>">Login</a></li>
                        <li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="<?php echo e(route('register')); ?>">Create Account</a></li>
                    </ul>
                </div>
            </div>
        </div>
