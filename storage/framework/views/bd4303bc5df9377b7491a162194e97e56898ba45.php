        ...
        <div class="carousel-inner">
            ...
            <?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="item <?php if($i == 1): ?> active <?php endif; ?>">
                    <a href="<?php echo e(route('user_news_view',['id' => $n->id *8009 * 8009])); ?>">
                        <header class="text-center" style=""><h2 style="font-size:20px !important; color:black;"><?php echo e(strtoupper($n->title)); ?></h2></header>
                        <p class="well-sm  container" style="color:black; font-weight: normal;!important;">
                            <?php echo e(\Illuminate\Support\Str::words($n->text,'30','...Read More.')); ?>
    ...
    <div class="container" style="margin-top:30px;">
        <?php if(count($fv) > 0): ?>
            <div class="row">
                ...
                <?php $__currentLoopData = $fv; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-3">
                        <a href="<?php if($f->link == null): ?> <?php echo e(route('listings')); ?> <?php else: ?> <?php echo e($f->link); ?> <?php endif; ?>" target="_blank" style="text-decoration:none;color:#0c63ff;">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <p>
                                        <img src="<?php echo e(route('file',['filename' => $f->image])); ?>" class="img img-rounded img-responsive" style="width:250px !important;height:200px !important;" />
                                    </p>
                                </div>
                            </div>
                        </a>
            ...
            <a href="<?php echo e(route('listings')); ?>" class="text-center col-lg-12" style="font-size:20px;color:white; background-color: #c52d2f;border-radius: 10px; margin-top: 30px !important;"><i class="fa fa-phone"></i> Call To Join Our Team</a>
            <br/><br/><br/>
        <?php endif; ?>
        ...
        <div class="row">
            ...
            <div class="container" style="margin-top:30px;">
                <div class="row">
                    <div class="col-lg-3">
                        <a href="<?php echo e(route('register')); ?>" style="text-decoration:none;color:#000;">
                    ...
                    <div class="col-lg-3">
                        <a href="<?php echo e(route('user_market')); ?>" style="text-decoration:none;color:#000;">
                            <div class="panel panel-default" style="border:none; !important;">
                                <div class="panel-body">
                                    <p>
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="text-center col-lg-12" style="font-size:20px;color:white; background-color: #c52d2f;border-radius: 10px; margin-top: 30px !important;">Join Now</a>
                </div>
            </div>
                    ...
                    <div class="panel panel-body">
                        ...
                        <ul class="list-group" style="word-wrap:break-word;padding:2px;">
                            <li class="list-group-item">
                                ...
                                <b>Note</b>:Make sure you <a href="<?php echo e(route('register')); ?>" style="margin-bottom:20px!important;" ><i>Join Now</i></a> through us<br /><br />
                            </li>
                        </ul>
                        </p>
                    </div>
