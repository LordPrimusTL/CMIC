        ...
        <header class="page-header">
            ...
            <div class="row">
                <div class="col-lg-12" style="margin-left: 10px;">
                    <p>Search Here...</p>
                    <form class="form-" method="POST" action="{{route('admin_user_search')}}">
                        {{csrf_field()}}
                        <div class="col-lg-3">
                            <div class="form-group-sm ">
                                ...
                                <a href="{{route('admin_dash')}}" style="margin-top: 5px;" class="btn btn-outline-primary btn-sm">All User</a>
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin_user_delete',['id' => $user->id * 8009 * 8009])}}" onclick="return confirm('Are you sure you want to delete this User?');" class="btn btn-outline-danger btn-sm"><i class="fa fa-trash"></i> Delete</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
