        ...
        <header class="page-header">
            ...
            <div class="row">
                            ...
                            <table id="table" class="table table-bordered">
                                ...
                                @foreach($adm as $a)
                                    <tr>
                                        ...
                                        <td> @if(Auth::user()->role_id == 1) <a href="{{route('admin_delete',['id' => $a->id * 8009 * 8009])}}" onclick="return confirm('Are you sure you want to delete this administrator? You can\'t Undo this Move');" class="btn btn-outline-danger btn-sm"><i class="fa fa-trash"></i> Delete</a>
                                        @else N/A @endif</td>
                                    </tr>
                                @endforeach
                                </tbody>
                ...
                <div class="col-lg-4">
                    ...
                    <form action="{{route('admin_admin')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
