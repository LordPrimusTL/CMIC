                            ...
                            <form class="form-" method="POST" action="{{route('admin_invs_search')}}">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group-sm ">
                                        ...
                                        <a href="{{route('admin_deals_app')}}" style="margin-top: 5px;" class="btn btn-outline-primary btn-sm">All</a>
                                    ...
                                    <tr class="@if($g == 1) alert-success @elseif($g == 2 || $g == 4) alert-warning @elseif($g == 3) alert-danger @endif">
                                        ...
                                        <td>
                                            @if($g == 1)
                                                N/A
                                            @elseif($g ==2)
                                                <a href="{{route('admin_deal_auth',['id' => $in->id * 8009 * 8009])}}" class="btn btn-outline-success btn-sm"><i class="fa fa-check"></i> Authorize</a>
                                                <a href="{{route('deal_decline',['id' => $in->id * 8009 * 8009])}}" class="btn btn-outline-danger btn-sm"><i class="fa fa-close"></i> Decline</a>
                                            @elseif($g == 3)
                                                No Action
                                            @elseif($g == 4)
                                                <a href="{{route('deal_comp',['id' => $in->id * 8009 * 8009])}}" class="btn btn-outline-success btn-sm"><i class="fa fa-check"></i> Completed</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
