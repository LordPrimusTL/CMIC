...
@section('content')
    ...
    <div class="breadcrumbs">
        <div class="container">
            <ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
                <div class="pull-left">
                    <li><a href="{{route('user_dashboard')}}"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>Home</a>/Dashboard</li>
    ...
    <div class="container" style="margin-top:30px;">
        <div class="row">
            <div class="col-lg-3">
                <a href="{{route('user_news')}}" style="text-decoration:none;color:white;">
            ...
            <div class="col-lg-3">
                <a href="{{route('invest')}}" style="text-decoration:none;color:white;">
                    <div class="panel" style="background-color:#ff0a11;">
                        <br />
                        <div class="panel-body">
            ...
            <div class="col-lg-3">
                <a href="{{route('user_finance')}}" style="text-decoration:none;color:white;">
                    <div class="panel" style="background-color:#ff0a11;">
                        <br /><br />
                        <div class="panel-body">
            ...
            <div class="col-lg-3">
                <a href="{{route('user_deals')}}" style="text-decoration:none;color:white;">
                    <div class="panel" style="background-color:#ff0a11;">
                        <br /><br />
                        <div class="panel-body">
            ...
            <div class="col-lg-3">
                <a href="{{route('user_awards')}}" style="text-decoration:none;color:white;">
                    <div class="panel" style="background-color:#ff0a11;">
                        <br /><br />
                        <div class="panel-body">
            ...
            <div class="col-lg-3">
                <a href="{{route('user_icj')}}" style="text-decoration:none;color:white;">
                    <div class="panel" style="background-color:#ff0a11;">
                        <br /><br />
                        <div class="panel-body">
                            <h3 class="panel-title text-center"><i class="fa fa-briefcase" style="font-size:40px;"></i></h3>
            ...
            <div class="col-lg-3">
                <a href="{{route('user_market')}}" style="text-decoration:none;color:white;">
                    <div class="panel" style="background-color:#ff0a11;">
                        <br/>
                        <div class="panel-body">
